...
::: {.callout-important}
## Profile: margin-idiom
We use the `margin-idiom` profile which includes additional packages for survival analysis (`dsSurvival`) and other advanced methods not available in the default profile.
:::
